                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form action="{{ route('invoices.store') }}" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <!-- Date input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="date" name='date' type="text" placeholder="Data" data-sb-validations="required" />
                            ...
                            <!-- Total value input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="total" name='total' type="text" placeholder="Kwota wymagana" data-sb-validations="required" />
